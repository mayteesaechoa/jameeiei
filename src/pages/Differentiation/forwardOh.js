...
class forwardOh extends Component {
    constructor(props) {
        super(props)
        this.state = {
            fx: "",
    ...
    forward(x, h) {
        fx = this.state.fx;
        fxforward = (this.func(x + h) - this.func(x)) / h;
        dfx = this.divx(x);
    ...
    render() {
        return (
            <div style={{ height: 1000, background: "#FFFF", padding: "30px" }}>
                <h2 style={{ color: "black", fontWeight: "bold" }}>Forward divided-difference O(h)</h2>
                    ...
                    {this.state.showinput &&
                        ...
                        >
                            ...
                            <Button id="submit_button" onClick={
                                () => this.forward(parseFloat(this.state.x), parseFloat(this.state.h))
                            }
