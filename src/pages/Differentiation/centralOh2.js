...
class centralOh2 extends Component {
    ...
    central(x, h) {
        fx = this.state.fx;
        fxforward = (this.func(x + h) - this.func(x - h)) / 2*h;
        dfx = this.divx(x);
    ...
    render() {
        return (
            <div style={{ height: 1000, background: "#FFFF", padding: "30px" }}>
                <h2 style={{ color: "black", fontWeight: "bold" }}>Central divided-difference O(h{<sup>2</sup>})</h2>
                    ...
                    {this.state.showinput &&
                        ...
                        >
                            ...
                            <Button id="submit_button" onClick={
                                () => this.central(parseFloat(this.state.x), parseFloat(this.state.h))
                            }
